...
class qdujw:
    ...
    def login(self, sid, passwd, url):
        ...
        userurl = url+'/graduate/studentinfo/infoView.do?groupId=&moduleId=20102'
        try:
            # 验证码 Captcha
...
root = tk.Tk()
root.title('Spider for Graduate Student Information System -- By Hollow Man')
